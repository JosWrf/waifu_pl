...
class FunctionDecl(Stmt):
    ...
    def __init__(self, decorator: Token, name: Token, params: List[Token], body: List[Stmt], static: bool = False) -> None:
...
class ClassDecl(Stmt):
    ...
    def __init__(self, name: Token, supercls: List[VarAccess], methods: List[Stmt]) -> None:
        self.name = name
